...
class DataMahasiswa2211104070 {
    ReadJSON() {
        try {
            const rawData = fs.readFileSync('./tp7_1_2211104070.json');
...
// Contoh penggunaan
const dataMahasiswa = new DataMahasiswa2211104070();
dataMahasiswa.ReadJSON();

module.exports = DataMahasiswa2211104070;